...
def get_spans(adult_df, a_variable, method = 'young', fraction = 0.5, reverse_direction = False,cutoff_value=None):
    '''
...
def quick_pearson(independent_variable, dependent_variable, r_mode = False):
    ...
    if r_mode:
        ...
        print(scipy.stats.pearsonr(my_frame[:, 0], my_frame[:, 1])[1])
        return r_squared
